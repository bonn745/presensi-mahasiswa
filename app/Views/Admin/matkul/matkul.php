...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <a href="<?= base_url('admin/matkul/create') ?>" class="btn btn-success">
                ...
                foreach ($matkul as $mk) : ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <button class="btn btn-sm btn-danger btn-delete" data-id="<?= $mk['id'] ?>">
...
<script>
    ...
    document.querySelectorAll('.btn-delete').forEach(button => {
        button.addEventListener('click', function() {
            let matkulId = this.getAttribute('data-id');
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "<?= base_url('admin/matkul/delete/') ?>" + matkulId;
                }
            });
        });
    });
